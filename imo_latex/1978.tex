...
\textbf{Problem 1.}
$m$ and $n$ are natural numbers with $1 \leq m < n$. In their decimal representations, the last three digits of $1978^m$ are equal, respectively, to the last three digits of $1978^n$. Find $m$ and $n$ such that $m + n$ has its least value.
...
\[
\{f(1), f(2), \ldots, f(n), \ldots\}, \quad \{g(1), g(2), \ldots, g(n), \ldots\},
\]
where
\[
f(1) < f(2) < \cdots < f(n) < \cdots, \quad g(1) < g(2) < \cdots < g(n) < \cdots,
\]
and
\[
